...
IF OBJECT_ID('dbo.loan_application_raw', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.customer_raw', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.collateral_raw', 'U') IS NULL
BEGIN
...
IF OBJECT_ID('dbo.branch_reference', 'U') IS NULL
BEGIN
